...
module.exports = class TaskVerification_ViewLoader {
        ...
        res["TASKVERIFICATION_SLFCOMMIT_TABLE"] = $('#tskv-selfcommits-table').DataTable({
            ...
            columnDefs: [
                ...
                ,
                {
                    "targets": -1,
                    "data": null,
                    "defaultContent": "<button id='tskv-ver-cmpl-btn' class=\"btn btn-outline-success btn-sm btn-circle btn-circle-sm\"><span class=\"material-icons\">check_circle</span></button><button id='tskv-ver-rej-btn' class=\"btn btn-outline-danger btn-sm btn-circle btn-circle-sm\"><span class=\"material-icons\">restore</span></button>"
                }
            ],
            select: {
                style: 'multi',
    ...
    loadSelfDeletesVerificationData(tabledata) {
        ...
        res["TASKVERIFICATION_SLFDELETE_TABLE"] = $('#tskv-selfdeletes-table').DataTable({
            ...
            columnDefs: [
                ...
                ,
                {
                    "targets": -1,
                    "data": null,
                    "defaultContent": "<button id='tskv-ver-del-btn' class=\"btn btn-outline-warning btn-sm btn-circle btn-circle-sm\"><span class=\"material-icons\">delete</span></button><button id='tskv-ver-rej-btn' class=\"btn btn-outline-danger btn-sm btn-circle btn-circle-sm\"><span class=\"material-icons\">restore</span></button>"
                }
            ],
            select: {
                style: 'multi',
        ...
        $("div.toolbar" , res["TASKVERIFICATION_SLFDELETE_TABLE"].table().container()).html('<span onclick="operationTrigger(\'tskv_MarkMultiTaskAsDelete\')" class="material-icons tsb-table-btn" style="border-left: 0px;">delete_outline</span><span onclick="operationTrigger(\'tskv_MarkMultiTaskAsRevert\' , \'SelfDeleteTable\')" class="material-icons tsb-table-btn">restore</span><span onclick="loadUIElement(\'display\' ,\'views/taskboard\' , \'All Tasks\')" class="material-icons tsb-table-btn">refresh</span>');
    ...
    loadAssignmentSummaryData(data)
    {
        ...
        let newValue = parentElement.children[0].children[0].children[0].children[1].children[0].children[0]
        let inProgressValue = parentElement.children[1].children[0].children[0].children[1].children[0].children[0]
        let pendingCommitValue = parentElement.children[2].children[0].children[0].children[1].children[0].children[0]
        let pendingDeleteValue = parentElement.children[3].children[0].children[0].children[1].children[0].children[0]
        let completeValue = parentElement.children[4].children[0].children[0].children[1].children[0].children[0]
        let deleteValue = parentElement.children[5].children[0].children[0].children[1].children[0].children[0]
